...
from kitty import controllers, fuzzers, targets
from kitty.model import GraphModel, Template, UInt8, UInt16
...
def new_session_callback(fuzzer, edge, resp):
    ...
    :param:
        ...
        edge: the edge in the graph we currently at.
              edge.src is the get_session template
              edge.dst is the send_data template
        resp: the response from the target
    '''
